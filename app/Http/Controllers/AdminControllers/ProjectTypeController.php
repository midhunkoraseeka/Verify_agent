...
class ProjectTypeController extends Controller
{
    ...
    {
        $request->validate([
            'project_type_name' => 'required|string|max:255|regex:/^(?=.*[a-zA-Z])[a-zA-Z0-9\s\-]+$/',
        ], [
            'project_type_name.regex' => 'The project type name must contain letters. Numbers, hyphens and spaces are optional.'
        ]);

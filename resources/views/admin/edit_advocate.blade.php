        ...
        <form class="property-form" action="{{ route('updateAdvocate', $advocate->id) }}" method="POST"
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group-container">
                        {{-- FIX: Added $advocate->mobile as fallback so it pre-fills on edit --}}
                        <input type="tel" class="form-control @error('mobile') is-invalid @enderror" name="mobile"
                            value="{{ old('mobile', $advocate->mobile) }}"
                    ...
                    <div class="multi-select-dropdown">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu w-100">
                                ...
                                @php
                                    $selectedServices = explode(', ', old('legal_services', $advocate->legal_services ?? ''));
                                @endphp
                ...
                <div class="col-md-4">
                    ...
                    <input type="url" class="form-control" name="instagram"
                        value="{{ old('instagram', $advocate->instagram) }}">
                </div>

                <div class="col-md-4">
                    <label class="form-label">LinkedIn (Optional)</label>
                    <input type="url" class="form-control" name="linkedin"
                        value="{{ old('linkedin', $advocate->linkedin) }}">
                </div>

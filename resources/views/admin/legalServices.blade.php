                    ...
                    <tr data-name="{{ strtolower($service->service_name) }}">
                        ...
                        <td class="text-end">
                            <div class="action-cell justify-content-end">
                                ...
                                <a href="{{ route('deleteLegalService', $service->id) }}"
                                ...
                                <form action="{{ route('updateLegalService', $service->id) }}" method="POST">
                                    ...
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            ...
                                            <span class="text-danger small service-error" style="display:none;">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('storeLegalService') }}" method="POST">
                @csrf
                <div class="modal-header">
                    <h5 class="modal-title">Add Legal Service</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <label class="form-label">Service Name <span class="req">*</span></label>
...
<script>
    ...
    document.addEventListener('submit', function (e) {
        ...
        if (input) {
            const isValid = validateService(input);

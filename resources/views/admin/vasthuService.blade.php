    ...
    <div class="page-head">
        ...
        <div class="action-group" style="display: flex; align-items: center; gap: 12px;">
            <div class="search-wrapper" style="position: relative;">
                ...
                <input type="text" id="vasthuServiceSearch" placeholder="Search vasthu service..."
                                ...
                                <form action="{{ route('updateVasthuService', $service->id) }}" method="POST">
                                    ...
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            ...
                                            <span class="text-danger small vasthu-service-error" style="display:none;">
            ...
            <form action="{{ route('storeVasthuService') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label class="form-label">Service Name <span class="req">*</span></label>
                        <input type="text" name="service_name" class="form-control"
                            placeholder="e.g. Home Vasthu, Bore Point"
                            oninput="this.value = this.value.replace(/[^a-zA-Z0-9\s\-]/g, '');">
                        <span class="text-danger small vasthu-service-error" style="display:none;">
                            Must contain at least letters. Numbers, hyphens and spaces are optional.
                        </span>
...
<script>
    // ── Search filter ──────────────────────────────────────────────
    document.getElementById('vasthuServiceSearch').addEventListener('input', function () {
    ...
    // ── Form validation ────────────────────────────────────────────
    function validateVasthuService(input) {
    ...
    document.addEventListener('submit', function (e) {
        ...
        if (input) {
            const isValid = validateVasthuService(input);

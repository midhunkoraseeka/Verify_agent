    ...
    public function manageFacing()
{
    ...
    {
        $request->validate([
            'facing_name' => 'required|string|max:255',
        ]);
    ...
    public function updateFacing(Request $request, $id)
{
    ...
    try {
        ...
        $facing->update([
            ...
            'updated_by' => session('agent_id'), // Tracking editor
        ]);
    ...
    public function deleteFacing($id)
    {
        try {
            ...
            return redirect()->route('admin.manageFacing')->with('success', 'Facing moved to trash!');
        } catch (Exception $e) {

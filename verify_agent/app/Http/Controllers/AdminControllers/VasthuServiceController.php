...
class VasthuServiceController extends Controller
{
    ...
    {
        $request->validate([
            'service_name' => 'required|string|max:255|unique:rl_vasthu_services_tbl,service_name',
        ]);
    ...
    {
        $request->validate([
            'service_name' => 'required|string|max:255|unique:rl_vasthu_services_tbl,service_name,' . $id,

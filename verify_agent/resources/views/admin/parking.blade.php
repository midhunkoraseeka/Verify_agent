...
<div class="content">
    <div class="page-head">
        ...
        <div class="action-group">
            <button type="button" class="btn-action btn-manage" data-bs-toggle="modal" data-bs-target="#addParkingModal">+ Add Parking</button>
        </div>
    </div>
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            <div class="action-cell justify-content-end">
                                <button type="button" class="action-btn btn-edit me-2" data-bs-toggle="modal" data-bs-target="#editParkingModal{{ $parking->id }}">Edit</button>
                                <a href="{{ route('deleteParking', $parking->id) }}" class="action-btn btn-delete text-decoration-none" onclick="return confirm('Delete this record?')">Delete</a>
                            </div>
                        </td>
                    </tr>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content text-start">
                                <form action="{{ route('updateParking', $parking->id) }}" method="POST">
                                    @csrf
                                    <div class="modal-header"><h5>Edit Parking</h5></div>
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            <label class="form-label">Parking Name <span class="req">*</span></label>
                                            <input type="text" name="parking_name" class="form-control" value="{{ $parking->parking_name }}" required>
                                        </div>
                                        <div class="mb-3">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('storeParking') }}" method="POST">
                @csrf
                <div class="modal-header"><h5>Add New Parking</h5></div>
                <div class="modal-body">
                    <label class="form-label">Parking Name <span class="req">*</span></label>
                    <input type="text" name="parking_name" class="form-control" placeholder="e.g. 2 Wheeler, 4 Wheeler" required>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
